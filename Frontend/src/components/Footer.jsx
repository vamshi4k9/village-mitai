...
export default function Footer() {
  ...
  return (
    <div>
      {/* <NewsLetter />
      <HorizontalScroller /> */}
      <footer className="py-5 footer" style={{ backgroundColor: "#3F2305", color: "#221100", marginTop:'70px' }}>
    ...
    <div className="col-md-4 flex justify-center mb-3">
      <img src={`${process.env.PUBLIC_URL}/images/villageLogoLong.png`} alt="Logo" className="object-scale-down w-40" />
            ...
            <div className="col-md-4 mb-3">
              <h5 style={{ color: "#f2ead3", textTransform: "uppercase", fontSize: "1rem" }}>Quick Links</h5>
            ...
            <div className="col-md-4 mb-3">
              <h5 style={{ color: "#f2ead3", textTransform: "uppercase", fontSize: "1rem" }}>Customer Service</h5>
              <ul className="list-unstyled">
